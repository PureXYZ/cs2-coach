...
async function registerAdminCommand(ready: Client<true>, adminGuildId: string | undefined): Promise<void> {
...
async function handleAdminCommand(interaction: ChatInputCommandInteraction, deps: BotDeps): Promise<void> {
...
async function handleAdminButton(interaction: ButtonInteraction, deps: BotDeps): Promise<void> {
